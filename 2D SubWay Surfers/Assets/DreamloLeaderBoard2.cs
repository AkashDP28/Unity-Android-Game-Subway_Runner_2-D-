...
public class DreamloLeaderBoard2 : MonoBehaviour
{
    ...
    public static DreamloLeaderBoard2 GetSceneDreamloLeaderboard()
    {
        var go = GameObject.Find("dreamloPrefab2");
        ...
        return go.GetComponent<DreamloLeaderBoard2>();
    }
